...
const detailedMovieData = {
    1: {
        ...
        synopsis: "జెన్షూ (Zenshu) అనే యువకుడు తన గతాన్ని గుర్తు చేసుకోలేడు. అతని మనసు లోతుల్లో ఏదో రహస్యం దాగి ఉంది. రోజులు గడుస్తున్న కొద్దీ, అతను తనలో ఉన్న శక్తిని, మరియు తన చుట్టూ ఉన్న ప్రపంచాన్ని అర్థం చేసుకునే ప్రయాణం మొదలుపెడ్తాడు. ఈ కథలో భావాలు, ఆత్మపరిశీలన, మరియు మానవత్వం కలగలిసిన అందమైన ప్రయాణం ఉంటుంది. జెన్షూ తెలుసుకోవాలనుకుంటాడు — అతను నిజంగా ఎవరో.",
        studio: "Mappa",
        format: "Season 01",
    ...
    2: {
        ...
        synopsis: "మోమో అనే అమ్మాయి ఆత్మలపై నమ్మకం ఉంచుతుంది,కానీ ఆమె స్నేహితుడు ఓకారున్ మాత్రం ఎలియన్లను నమ్ముతాడు. ఒక రోజు ఇద్దరూ తమ నమ్మకాలు నిజమా కాదా తెలుసుకోవడానికి వేర్వేరు ప్రదేశాలకు వెళ్తారు — కానీ అక్కడ జరిగేది ఊహించని సంఘటన! ఇద్దరూ కలిసి ఆత్మలు, ఎలియన్లు, మరియు విచిత్ర శక్తులు ఎదుర్కొంటారు, వాటివల్ల తమ  జీవితాలు ఎలా మారాయి . వాళ్ళు ఎలాంటి సంఘటనలు ఎదురుకున్నారు అనేది సిరీస్ చూసి తెసులుసుకోవాలి. ",
        studio: "Science SARU",
        format: "Season 01",
...
class TeluguFontManager {
    ...
    verifyTeluguFonts() {
        ...
        const teluguChar = 'అ'; // Telugu letter A
    ...
    updateContentWithTelugu() {
        ...
        if (movieTitle) {
            ...
            const teluguTitles = {
                'The Martian': 'ది మార్టియన్',
                'Demon Slayer': 'డెమన్ స్లేయర్',
                'My Hero Academia': 'మై హీరో అకాడెమియా'
            };
    ...
    studioDiv.innerHTML = `
        <div class="cast-left">
            ...
            <div class="cast-info">
                ...
                <div class="cast-role">${studio.role}${studio.location ? ` • ${studio.location}` : ''}</div>
            </div>
        </div>
        <div class="cast-right">
            <div class="character-info">
